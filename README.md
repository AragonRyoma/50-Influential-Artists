...
My favorite concept is how easy it is to read. My biggest trouble comes from Flex box.

3. How would you explain the concept of a variable to someone new to programming?

Variables are just names we might come up for data types.

4. What is the purpose of using functions in code?

The purpose of using functions is so that we can reuse long strings of code using shorthands and to pass in data that we may not know yet.

5. What is a JSON data?

The types of date we use in Json are as follow,
a string
a number
an object
an array
